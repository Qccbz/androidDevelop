...
import q.baselibrary.utils.QShell.CommandResult;
...
public class QPackage {
    ...
    public static final int install(Context context, String filePath) {
        if (QPackage.isSystemApplication(context) || QShell.checkRootPermission()) {
     ...
     * @param context
     * @param filePath file path of package
     * @return {@link QPackage#INSTALL_SUCCEEDED} means install success, other means failed. details see
     * {@link QPackage}.INSTALL_FAILED_*. same to {@link PackageManager}.INSTALL_*
    ...
    public static int installSilent(Context context, String filePath, String pmParams) {
        ...
        CommandResult commandResult = QShell.execCommand(command.toString(), !isSystemApplication(context), true);
    ...
    public static Boolean isTopActivity(Context context, String packageName) {
        if (context == null || QString.isEmpty(packageName)) {
            return null;
        }

        ActivityManager activityManager = (ActivityManager) context.getSystemService(Context.ACTIVITY_SERVICE);
        List<RunningTaskInfo> tasksInfo = activityManager.getRunningTasks(1);
        if (QList.isEmpty(tasksInfo)) {
            return null;
        }
        try {
    ...
    public static int getInstallLocation() {
        CommandResult commandResult = QShell.execCommand(
