...
public class QRandom {
     ...
     * @param length
     * @return
     * @see QRandom#getRandom(String source, int length)
     */
     ...
     * <li>else see {@link QRandom#getRandom(char[] sourceChar, int length)}</li>
     * </ul>
     */
    public static String getRandom(String source, int length) {
        return QString.isEmpty(source) ? null : getRandom(source.toCharArray(), length);
    }
