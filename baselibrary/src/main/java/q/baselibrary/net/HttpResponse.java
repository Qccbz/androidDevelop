package q.baselibrary.net;

import java.util.HashMap;
import java.util.Map;

import q.baselibrary.utils.QHttp;
import q.baselibrary.utils.QString;
import q.baselibrary.utils.QTime;
...
public class HttpResponse {
    ...
    public boolean isExpired() {
        return QTime.getCurrentTimeInLong() > expiredTime;
    }
    ...
    private long getCacheControlMaxAge() {
        try {
            ...
            if (!QString.isEmpty(cacheControl)) {
    ...
    private long getExpiresInMillis() {
        ...
        if (maxAge != -1) {
            ...
            if (!QString.isEmpty(expire)) {
                return QHttp.parseGmtTime(getExpiresHeader());
            }
        }
        return -1;
    }
